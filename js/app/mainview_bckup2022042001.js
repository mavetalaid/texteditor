...
var countryselected;
var indexCategory = 1;
var MainView_bckup2022042001 = /** @class */ (function () {
    function MainView_bckup2022042001() {
    }
    MainView_bckup2022042001.prototype.Show = function () {
        this.ShowCategory();
        this.ShowCategory1();
        // this.ShowCategory2();
        // this.ShowCategory3();
    ...
    MainView_bckup2022042001.prototype.Showheader = function () {
    ...
    MainView_bckup2022042001.prototype.ShowBanner = function () {
    ...
    MainView_bckup2022042001.prototype.ShowBanner1 = function () {
        var container = document.getElementById("banner");
    ...
    MainView_bckup2022042001.prototype.ShowCategory = function () {
    ...
    MainView_bckup2022042001.prototype.ShowCategory1 = function () {
    ...
    MainView_bckup2022042001.prototype.ShowCategory2 = function () {
    ...
    MainView_bckup2022042001.prototype.ShowCategory3 = function () {
    ...
    MainView_bckup2022042001.prototype.ShowCategory4 = function () {
    ...
    MainView_bckup2022042001.prototype.ShowCategory5 = function () {
    ...
    MainView_bckup2022042001.prototype.ShowCategory6 = function () {
    ...
    MainView_bckup2022042001.prototype.ShowCategory7 = function () {
    ...
    MainView_bckup2022042001.prototype.ShowIndicators = function (indicator, description, texts) {
        var self = this;
        var container = document.getElementById("indicator");
        container.innerHTML = "";
        var catdes = new Xplore.Container({ classes: ["category-desc"] }); // category
        var titlecategory = catdes.Add(new Xplore.Text({ text: indicator }));
        var desccategory = catdes.Add(new Xplore.Text({ text: description }));
        catdes.Show(container);
        var catcontainer = new Xplore.Container({ classes: ["catcontainer"] }); // indicator
        var titleindi = catcontainer.Add(new Xplore.Text({ text: indicator, classes: ["catheader"] }));
        var descindi = catcontainer.Add(new Xplore.TextBlock({ text: description, classes: ["indicator-desc"] }));
    ...
    MainView_bckup2022042001.prototype.ShowIndicators2 = function (container, texts, availabledata) {
        var self = this;
    ...
    MainView_bckup2022042001.prototype.ShowIndicators3 = function (container, texts, availabledata) {
        var self = this;
        var grid = new Xplore.Grid({ classes: ["grid-indicator"] });
        grid.rows = 2;
        grid.columns = 1;
    ...
    MainView_bckup2022042001.prototype.ShowIndicators4 = function (container, texts, availabledata) {
        var self = this;
        var grid = new Xplore.Grid({ classes: ["grid-indicator"] });
        grid.rows = 2;
        grid.columns = 2;
    ...
    MainView_bckup2022042001.prototype.ShowIndicators5 = function (container, texts, availabledata) {
        var self = this;
        var grid = new Xplore.Grid({ classes: ["grid-indicator"] });
        grid.rows = 3;
        grid.columns = 1;
    ...
    MainView_bckup2022042001.prototype.ShowIndicators6 = function (container, texts, availabledata) {
        var self = this;
        var grid = new Xplore.Grid({ classes: ["grid-indicator"] });
        grid.rows = 3;
        grid.columns = 1;
    ...
    MainView_bckup2022042001.prototype.ShowIndicators7 = function (container, texts, availabledata) {
        var self = this;
        ...
        toolbar.Add(new Xplore.Button({
            ...
            onclick: function () {
                readmoreclick = true;
                self.ShowDetailsView(texts[6]);
            }
        }));
        grid.Show(container);
    };
    MainView_bckup2022042001.prototype.ShowVisualization = function (type) {
        var self = this;
    ...
    MainView_bckup2022042001.prototype.ShowAll = function (type) {
        var self = this;
        var container = document.getElementById("visualization");
        container.innerHTML = "";
        // let header = new Xplore.Container({ text: " ", classes: ["catheader"] });
    ...
    MainView_bckup2022042001.prototype.ShowDetailsView = function (type) {
        var self = this;
    ...
    MainView_bckup2022042001.prototype.ShowData = function (container, type) {
        var view = new DataViewMore(container, type);
        view.Show();
    };
    MainView_bckup2022042001.prototype.ShowMetadata = function (container, type) {
        var view = new MataDataViewMore(container, type);
        view.Show();
    };
    MainView_bckup2022042001.prototype.ShowMaterialUse = function (container) {
    ...
    MainView_bckup2022042001.prototype.ShowEnergyUse = function (container) {
    ...
    MainView_bckup2022042001.prototype.ShowWaterUse = function (container) {
        // let todo = new Xplore.Text({ text: "Under Development", classes: ["under_dev"] })
        // todo.Show(container);
        var category = new NaturalResources();
    ...
    MainView_bckup2022042001.prototype.ShowLandUse = function (container) {
        // let todo = new Xplore.Text({ text: "Under Development", classes: ["under_dev"] })
        // todo.Show(container);
        var category = new NaturalResources();
    ...
    MainView_bckup2022042001.prototype.ShowAgriProd = function (container) {
        // let todo = new Xplore.Text({ text: "Under Development", classes: ["under_dev"] })
        // todo.Show(container);
        var category = new NaturalResources();
    ...
    MainView_bckup2022042001.prototype.ShowGreenhouseGas = function (container) {
        var category = new NaturalResources();
    ...
    MainView_bckup2022042001.prototype.ShowWasteManage = function (container) {
        var category = new NaturalResources();
    ...
    MainView_bckup2022042001.prototype.ShowMaterialIntensity = function (container) {
    ...
    MainView_bckup2022042001.prototype.ShowEnergyIntensity = function (container) {
        var category = new ResourceEfficiency();
    ...
    MainView_bckup2022042001.prototype.ShowGHGIntensity = function (container) {
        var category = new ResourceEfficiency();
    ...
    MainView_bckup2022042001.prototype.ShowWaterIntensity = function (container) {
        var category = new ResourceEfficiency();
        category.GetWaterIntensityAsiaPacific(function (data) {
            var expander = new Xplore.Expander({ text: data.charttitle });
            var description;
    ...
    MainView_bckup2022042001.prototype.ShowEmissionEnSect = function (container) {
    ...
    MainView_bckup2022042001.prototype.ShowMaterialFootprint = function (container) {
    ...
    MainView_bckup2022042001.prototype.ShowWaterFootprint = function (container) {
        var category = new Consumption();
    ...
    MainView_bckup2022042001.prototype.ShowPTB = function (container) {
    ...
    MainView_bckup2022042001.prototype.ShowUnitPriceTrade = function (container) {
        var category = new TradeDependency();
    ...
    MainView_bckup2022042001.prototype.ShowHDI = function (container) {
    ...
    //     });
    // }
    MainView_bckup2022042001.prototype.ShowEconGrowth = function (container) {
        var category = new ResourceHumanDev();
    ...
    MainView_bckup2022042001.prototype.ShowInvestmentCons = function (container) {
        var category = new ResourceHumanDev();
    ...
    MainView_bckup2022042001.prototype.ShowDebtInflation = function (container) {
        var category = new ResourceHumanDev();
    ...
    MainView_bckup2022042001.prototype.ShowAccessEWS = function (container) {
        var category = new ResourceHumanDev();
    ...
    MainView_bckup2022042001.prototype.ShowCOVIDSpend = function (container) {
    ...
    MainView_bckup2022042001.prototype.ShowNaturalCapital = function (container) {
        var category = new InclusiveGreenRecovery();
    ...
    MainView_bckup2022042001.prototype.ShowGreenSpend = function (container) {
        var category = new InclusiveGreenRecovery();
    ...
    MainView_bckup2022042001.prototype.ShowGreenEnergy = function (container) {
        var category = new InclusiveGreenRecovery();
    ...
    MainView_bckup2022042001.prototype.ShowGreenTransport = function (container) {
        var category = new InclusiveGreenRecovery();
    ...
    MainView_bckup2022042001.prototype.ShowGreenResDev = function (container) {
        var category = new InclusiveGreenRecovery();
    ...
    MainView_bckup2022042001.prototype.ShowBiofuelProd = function (container) {
        // let todo = new Xplore.Text({ text: "Under Development", classes: ["under_dev"] })
        // todo.Show(container);
        var category = new InclusiveGreenRecovery();
    ...
    MainView_bckup2022042001.prototype.ShowFooter = function () {
    ...
    MainView_bckup2022042001.prototype.DataSet = function () {
    ...
    MainView_bckup2022042001.prototype.ScatterDataSet = function () {
        var dataset = new XChartDataSet();
        var labelx = [];
        for (var i = 0; i < 10; i++)
            labelx.push((i).toString());
    ...
    MainView_bckup2022042001.prototype.Share = function (id) {
        switch (id) {
            case "NRAsiaPacific":
    ...
    //------------ Material Use ---------------
    MainView_bckup2022042001.prototype.ShareNRAsiaPacific = function () {
    ...
    MainView_bckup2022042001.prototype.ShareNRAsiaPacificMaterial = function () {
        var container = document.getElementsByClassName("box-layout");
        container[0].remove();
        var category = new NaturalResources();
        category.GetNRAsiaPacificMaterial(function (data) {
    ...
    MainView_bckup2022042001.prototype.ShareNRAsiaPacificWorld = function () {
        var container = document.getElementsByClassName("box-layout");
        container[0].remove();
        var category = new NaturalResources();
        category.GetNRAsiaPacificWorld(function (data) {
    ...
    MainView_bckup2022042001.prototype.ShareNRAsiaPacificDeveloping = function () {
        var container = document.getElementsByClassName("box-layout");
        container[0].remove();
        var category = new NaturalResources();
        category.GetNRAsiaPacificDeveloping(function (data) {
    ...
    MainView_bckup2022042001.prototype.ShareNRAsiaPacificIndustrialized = function () {
        var container = document.getElementsByClassName("box-layout");
        container[0].remove();
        var category = new NaturalResources();
        category.GetNRAsiaPacificIndustrialized(function (data) {
    ...
    //------------ Energy Use ---------------
    MainView_bckup2022042001.prototype.ShareREAsiaPacificWorld = function () {
        var container = document.getElementsByClassName("box-layout");
        container[0].remove();
        var category = new NaturalResources();
        category.GetREAsiaPacificWorld(function (data) {
    ...
    MainView_bckup2022042001.prototype.ShareREAsiaPacificDeveloping = function () {
        var container = document.getElementsByClassName("box-layout");
        container[0].remove();
        var category = new NaturalResources();
        category.GetREAsiaPacificDeveloping(function (data) {
    ...
    //------------ Water Use ---------------
    MainView_bckup2022042001.prototype.ShareTotalWaterAsiaPacific = function () {
        var container = document.getElementsByClassName("box-layout");
        container[0].remove();
        var category = new NaturalResources();
        category.GetTotalWaterAsiaPacific(function (data) {
    ...
    MainView_bckup2022042001.prototype.ShareWaterSecAsiaPacific = function () {
        var container = document.getElementsByClassName("box-layout");
        container[0].remove();
        var category = new NaturalResources();
        category.GetWaterSecAsiaPacific(function (data) {
    ...
    MainView_bckup2022042001.prototype.ShareWaterCapitaAsiaPacific = function () {
        var container = document.getElementsByClassName("box-layout");
        container[0].remove();
        var category = new NaturalResources();
        category.GetWaterCapitaAsiaPacific(function (data) {
    ...
    MainView_bckup2022042001.prototype.ShareWaterIntensityAsiaPacific = function () {
        var container = document.getElementsByClassName("box-layout");
        container[0].remove();
        var category = new NaturalResources();
        category.GetWaterIntensityAsiaPacific(function (data) {
    ...
    MainView_bckup2022042001.prototype.ShareAgriWaterAsiaPacific = function () {
        var container = document.getElementsByClassName("box-layout");
        container[0].remove();
        var category = new NaturalResources();
        category.GetAgriWaterAsiaPacific(function (data) {
    ...
    MainView_bckup2022042001.prototype.ShareWaterAsiaPacific = function () {
        var container = document.getElementsByClassName("box-layout");
        container[0].remove();
        var category = new NaturalResources();
        category.GetWaterAsiaPacific(function (data) {
    ...
    MainView_bckup2022042001.prototype.ShareWaterFPAsiaPacific = function () {
        var container = document.getElementsByClassName("box-layout");
        container[0].remove();
        var category = new NaturalResources();
        category.GetWaterFPAsiaPacific(function (data) {
    ...
    //------------ Land Use ---------------
    MainView_bckup2022042001.prototype.ShareTotalLand = function () {
        var container = document.getElementsByClassName("box-layout");
        container[0].remove();
        var category = new NaturalResources();
        category.GetTotalLand(function (data) {
    ...
    MainView_bckup2022042001.prototype.ShareTotalLandCapita = function () {
        var container = document.getElementsByClassName("box-layout");
        container[0].remove();
        var category = new NaturalResources();
        category.GetTotalLandCapita(function (data) {
    ...
    MainView_bckup2022042001.prototype.ShareLandSector2015 = function () {
        var container = document.getElementsByClassName("box-layout");
        container[0].remove();
        var category = new NaturalResources();
        category.GetLandSector2015(function (data) {
    ...
    MainView_bckup2022042001.prototype.ShareLandIntensity = function () {
        var container = document.getElementsByClassName("box-layout");
        container[0].remove();
        var category = new NaturalResources();
        category.GetLandIntensity(function (data) {
    ...
    MainView_bckup2022042001.prototype.ShareLandProductivity = function () {
        var container = document.getElementsByClassName("box-layout");
        container[0].remove();
        var category = new NaturalResources();
        category.GetLandProductivity(function (data) {
    ...
    MainView_bckup2022042001.prototype.ShareLandMajorSector = function () {
        var container = document.getElementsByClassName("box-layout");
        container[0].remove();
        var category = new NaturalResources();
        category.GetLandMajorSector(function (data) {
    ...
    MainView_bckup2022042001.prototype.ShareGHGEmissions = function () {
        var container = document.getElementsByClassName("box-layout");
        container[0].remove();
        var category = new NaturalResources();
        category.GetGHGEmissions(function (data) {
    ...
    MainView_bckup2022042001.prototype.ShareGHGResultAgri = function () {
        var container = document.getElementsByClassName("box-layout");
        container[0].remove();
        var category = new NaturalResources();
        category.GetGHGResultAgri(function (data) {
    ...
    MainView_bckup2022042001.prototype.ShareGHGCompare = function () {
        var container = document.getElementsByClassName("box-layout");
        container[0].remove();
        var category = new NaturalResources();
        category.GetGHGCompare(function (data) {
    ...
    MainView_bckup2022042001.prototype.ShareGHGCO2 = function () {
        var container = document.getElementsByClassName("box-layout");
        container[0].remove();
        var category = new NaturalResources();
        category.GetGHGCO2(function (data) {
    ...
    MainView_bckup2022042001.prototype.ShareGHGIntensity = function () {
        var container = document.getElementsByClassName("box-layout");
        container[0].remove();
        var category = new NaturalResources();
        category.GetGHGIntensity(function (data) {
    ...
    MainView_bckup2022042001.prototype.ShareCereal = function () {
        var container = document.getElementsByClassName("box-layout");
        container[0].remove();
        var category = new NaturalResources();
        category.GetCereal(function (data) {
    ...
    MainView_bckup2022042001.prototype.ShareCompareAgri = function () {
        var container = document.getElementsByClassName("box-layout");
        container[0].remove();
        var category = new NaturalResources();
        category.GetCompareAgri(function (data) {
    ...
    MainView_bckup2022042001.prototype.ShareAgriAsiaPacific = function () {
        var container = document.getElementsByClassName("box-layout");
        container[0].remove();
        var category = new NaturalResources();
        category.GetAgriAsiaPacific(function (data) {
    ...
    //------------ Greenhouse Gas Emissions ---------------
    MainView_bckup2022042001.prototype.ShareGHGEmissionEnergy = function () {
        var container = document.getElementsByClassName("box-layout");
        container[0].remove();
        var category = new NaturalResources();
        category.GetGHGEmissionEnergy(function (data) {
    ...
    //------------ Waste Management ---------------
    MainView_bckup2022042001.prototype.ShareMWCove = function () {
        var container = document.getElementsByClassName("box-layout");
        container[0].remove();
        var category = new NaturalResources();
        category.GetMWCove(function (data) {
    ...
    MainView_bckup2022042001.prototype.ShareMWRecycled = function () {
        var container = document.getElementsByClassName("box-layout");
        container[0].remove();
        var category = new NaturalResources();
        category.GetMWRecycled(function (data) {
    ...
    MainView_bckup2022042001.prototype.ShareHWGenerated = function () {
        var container = document.getElementsByClassName("box-layout");
        container[0].remove();
        var category = new NaturalResources();
        category.GetHWGenerated(function (data) {
    ...
    MainView_bckup2022042001.prototype.ShareHWIncinerated = function () {
        var container = document.getElementsByClassName("box-layout");
        container[0].remove();
        var category = new NaturalResources();
        category.GetHWIncinerated(function (data) {
    ...
    MainView_bckup2022042001.prototype.ShareMWCollected = function () {
        var container = document.getElementsByClassName("box-layout");
        container[0].remove();
        var category = new NaturalResources();
        category.GetMWCollected(function (data) {
    ...
    // --------- Material Intensity of the economy---------------
    MainView_bckup2022042001.prototype.ShareMREAsiaPacificWorld = function () {
        var container = document.getElementsByClassName("box-layout");
        container[0].remove();
        var category = new ResourceEfficiency();
        category.GetREAsiaPacificWorld(function (data) {
    ...
    MainView_bckup2022042001.prototype.ShareMREAsiaPacificDeveloping = function () {
        var container = document.getElementsByClassName("box-layout");
        container[0].remove();
        var category = new ResourceEfficiency();
        category.GetREAsiaPacificDeveloping(function (data) {
    ...
    MainView_bckup2022042001.prototype.ShareMREAsiaPacificIndustry = function () {
        var container = document.getElementsByClassName("box-layout");
        container[0].remove();
        var category = new ResourceEfficiency();
        category.GetREAsiaPacificIndustry(function (data) {
    ...
    // --------- Energy intensity of the economy---------------
    MainView_bckup2022042001.prototype.Shareeigdpasiapacificworld = function () {
        var container = document.getElementsByClassName("box-layout");
        container[0].remove();
        var category = new ResourceEfficiency();
        category.Geteigdpasiapacificworld(function (data) {
    ...
    MainView_bckup2022042001.prototype.Shareeiasiapacificdeveloping = function () {
        var container = document.getElementsByClassName("box-layout");
        container[0].remove();
        var category = new ResourceEfficiency();
        category.Geteiasiapacificdeveloping(function (data) {
    ...
    // --------- GHG intensity of the economy---------------
    MainView_bckup2022042001.prototype.Shareco2asiapacific = function () {
        var container = document.getElementsByClassName("box-layout");
        container[0].remove();
        var category = new ResourceEfficiency();
        category.Getco2asiapacific(function (data) {
    ...
    // --------- Water intensity of the economy---------------
    MainView_bckup2022042001.prototype.ShareREWaterIntensityAsiaPacific = function () {
        var container = document.getElementsByClassName("box-layout");
        container[0].remove();
        var category = new ResourceEfficiency();
        category.GetWaterIntensityAsiaPacific(function (data) {
    ...
    // --------- Emissions of the energy sector---------------
    MainView_bckup2022042001.prototype.ShareRUGHGEmissionEnergy = function () {
        var container = document.getElementsByClassName("box-layout");
        container[0].remove();
        var category = new ResourceUse();
        category.GetGHGEmissionEnergy(function (data) {
    ...
    //--------------------------- Material Footprint ---------------------------------
    MainView_bckup2022042001.prototype.ShareCBMFAsiaPacificDeveloping = function () {
        var container = document.getElementsByClassName("box-layout");
        container[0].remove();
        var category = new Consumption();
        category.GetCBMFAsiaPacificDeveloping(function (data) {
    ...
    MainView_bckup2022042001.prototype.ShareCBMFAsiaPacificWorld = function () {
        var container = document.getElementsByClassName("box-layout");
        container[0].remove();
        var category = new Consumption();
        category.GetCBMFAsiaPacificWorld(function (data) {
    ...
    MainView_bckup2022042001.prototype.ShareCBMFCompared = function () {
        var container = document.getElementsByClassName("box-layout");
        container[0].remove();
        var category = new Consumption();
        category.GetCBMFCompared(function (data) {
    ...
    MainView_bckup2022042001.prototype.ShareCBMFCAsiaPacificDeveloping = function () {
        var container = document.getElementsByClassName("box-layout");
        container[0].remove();
        var category = new Consumption();
        category.GetCBMFCAsiaPacificDeveloping(function (data) {
    ...
    MainView_bckup2022042001.prototype.ShareCBMFCAsiaPacificIndustralized = function () {
        var container = document.getElementsByClassName("box-layout");
        container[0].remove();
        var category = new Consumption();
        category.GetCBMFCAsiaPacificIndustralized(function (data) {
    ...
    //--------------------------- Water Footprint ---------------------------------
    MainView_bckup2022042001.prototype.ShareCBMFWaterAsiaPacific = function () {
        var container = document.getElementsByClassName("box-layout");
        container[0].remove();
        var category = new Consumption();
        category.GetCBMFWaterAsiaPacific(function (data) {
    ...
    //--------------------------- Physical trade balance  ---------------------------------
    MainView_bckup2022042001.prototype.ShareTDPTBMaterialCategory = function () {
        var container = document.getElementsByClassName("box-layout");
        container[0].remove();
        var category = new TradeDependency();
        category.GetTDPTBMaterialCategory(function (data) {
    ...
    MainView_bckup2022042001.prototype.ShareTDPTBCSIRO = function () {
        var container = document.getElementsByClassName("box-layout");
        container[0].remove();
        var category = new TradeDependency();
        category.GetTDPTBCSIRO(function (data) {
    ...
    MainView_bckup2022042001.prototype.ShareTDPTBAsiaPacificWorld = function () {
        var container = document.getElementsByClassName("box-layout");
        container[0].remove();
        var category = new TradeDependency();
        category.GetTDPTBAsiaPacificWorld(function (data) {
    ...
    MainView_bckup2022042001.prototype.ShareTDPTBAsiaPacific = function () {
        var container = document.getElementsByClassName("box-layout");
        container[0].remove();
        var category = new TradeDependency();
        category.GetTDPTBAsiaPacific(function (data) {
    ...
    MainView_bckup2022042001.prototype.ShareTDPTBCapitaAsiaPacificWorld = function () {
        var container = document.getElementsByClassName("box-layout");
        container[0].remove();
        var category = new TradeDependency();
        category.GetTDPTBCapitaAsiaPacificWorld(function (data) {
    ...
    //--------------------------- Unit price of trade ---------------------------------
    MainView_bckup2022042001.prototype.ShareTDUPIAsiaPacificDeveloping = function () {
        var container = document.getElementsByClassName("box-layout");
        container[0].remove();
        var category = new TradeDependency();
        category.GetTDUPIAsiaPacificDeveloping(function (data) {
    ...
    MainView_bckup2022042001.prototype.ShareTDUPEAsiaPacificDeveloping = function () {
        var container = document.getElementsByClassName("box-layout");
        container[0].remove();
        var category = new TradeDependency();
        category.GetTDUPEAsiaPacificDeveloping(function (data) {
    ...
    //------------------------- COVID spending -----------------------
    MainView_bckup2022042001.prototype.ShareIGRCovid = function () {
        var container = document.getElementsByClassName("box-layout");
        container[0].remove();
        var category = new InclusiveGreenRecovery();
        category.GetIGRCovid(function (data) {
    ...
    //------------------------- Natural capital -----------------------
    MainView_bckup2022042001.prototype.ShareIGRNaturalCapital = function () {
        var container = document.getElementsByClassName("box-layout");
        container[0].remove();
        var category = new InclusiveGreenRecovery();
        category.GetIGRNaturalCapital(function (data) {
    ...
    //------------------------- Green spending -----------------------
    MainView_bckup2022042001.prototype.ShareIGRTotalGreenRecovery = function () {
        var container = document.getElementsByClassName("box-layout");
        container[0].remove();
        var category = new InclusiveGreenRecovery();
        category.GetIGRTotalGreenRecovery(function (data) {
    ...
    //------------------------- Green energy investments -----------------------
    MainView_bckup2022042001.prototype.ShareIGRGreenEnergySubregion = function () {
        var container = document.getElementsByClassName("box-layout");
        container[0].remove();
        var category = new InclusiveGreenRecovery();
        category.GetIGRGreenEnergySubregion(function (data) {
    ...
    MainView_bckup2022042001.prototype.ShareIGRGreenEnergyCountry = function () {
        var container = document.getElementsByClassName("box-layout");
        container[0].remove();
        var category = new InclusiveGreenRecovery();
        category.GetIGRGreenEnergyCountry(function (data) {
    ...
    //------------------------- Green Transport -----------------------
    MainView_bckup2022042001.prototype.ShareIGRElectric = function () {
        var container = document.getElementsByClassName("box-layout");
        container[0].remove();
        var category = new InclusiveGreenRecovery();
        category.GetIGRElectric(function (data) {
    ...
    //------------------------- Biofuel production-Green Spending -----------------------
    MainView_bckup2022042001.prototype.ShareIGRBiofuelProduction = function () {
        var container = document.getElementsByClassName("box-layout");
        container[0].remove();
        var category = new InclusiveGreenRecovery();
        category.GetIGRBiofuelProduction(function (data) {
    ...
    //------------------------- Green research and development -----------------------
    MainView_bckup2022042001.prototype.ShareIGRFinancial = function () {
        var container = document.getElementsByClassName("box-layout");
        container[0].remove();
        var category = new InclusiveGreenRecovery();
        category.GetIGRFinancial(function (data) {
    ...
    //------------------------- Human Development Index (HDI) -----------------------------------
    MainView_bckup2022042001.prototype.SharerhHDIdmc2010 = function () {
        var container = document.getElementsByClassName("box-layout");
        container[0].remove();
        var category = new ResourceHumanDev();
        category.GetrhHDIdmc2010(function (data) {
    ...
    MainView_bckup2022042001.prototype.SharerhHDIdmc2017 = function () {
        var container = document.getElementsByClassName("box-layout");
        container[0].remove();
        var category = new ResourceHumanDev();
        category.GetrhHDIdmc2017(function (data) {
    ...
    MainView_bckup2022042001.prototype.SharerhHDImf2010 = function () {
        var container = document.getElementsByClassName("box-layout");
        container[0].remove();
        var category = new ResourceHumanDev();
        category.GetrhHDImf2010(function (data) {
    ...
    MainView_bckup2022042001.prototype.SharerhHDImf2017 = function () {
        var container = document.getElementsByClassName("box-layout");
        container[0].remove();
        var category = new ResourceHumanDev();
        category.GetrhHDImf2017(function (data) {
    ...
    MainView_bckup2022042001.prototype.SharerhGDPdmc2010 = function () {
        var container = document.getElementsByClassName("box-layout");
        container[0].remove();
        var category = new ResourceHumanDev();
        category.GetrhGDPdmc2010(function (data) {
    ...
    MainView_bckup2022042001.prototype.SharerhGDPdmc2017 = function () {
        var container = document.getElementsByClassName("box-layout");
        container[0].remove();
        var category = new ResourceHumanDev();
        category.GetrhGDPdmc2017(function (data) {
    ...
    MainView_bckup2022042001.prototype.SharerhGDPmf2010 = function () {
        var container = document.getElementsByClassName("box-layout");
        container[0].remove();
        var category = new ResourceHumanDev();
        category.GetrhGDPmf2010(function (data) {
    ...
    MainView_bckup2022042001.prototype.SharerhGDPmf2017 = function () {
        var container = document.getElementsByClassName("box-layout");
        container[0].remove();
        var category = new ResourceHumanDev();
        category.GetrhGDPmf2017(function (data) {
    ...
    //------------------------- Economic Growth (GDP) -----------------------------------
    MainView_bckup2022042001.prototype.SharerhEGDPdmc2010 = function () {
        var container = document.getElementsByClassName("box-layout");
        container[0].remove();
        var category = new ResourceHumanDev();
        category.GetrhEGDPdmc2010(function (data) {
    ...
    MainView_bckup2022042001.prototype.SharerhEGDPdmc2017 = function () {
        var container = document.getElementsByClassName("box-layout");
        container[0].remove();
        var category = new ResourceHumanDev();
        category.GetrhEGDPdmc2017(function (data) {
    ...
    MainView_bckup2022042001.prototype.SharerhEGDPmf2010 = function () {
        var container = document.getElementsByClassName("box-layout");
        container[0].remove();
        var category = new ResourceHumanDev();
        category.GetrhEGDPmf2010(function (data) {
    ...
    MainView_bckup2022042001.prototype.SharerhEGDPmf2017 = function () {
        var container = document.getElementsByClassName("box-layout");
        container[0].remove();
        var category = new ResourceHumanDev();
        category.GetrhEGDPmf2017(function (data) {
    ...
    //------------------------- Investment and consumption -----------------------------------
    MainView_bckup2022042001.prototype.ShareRHFDIIndiaChina = function () {
        var container = document.getElementsByClassName("box-layout");
        container[0].remove();
        var category = new ResourceHumanDev();
        category.GetRHFDIIndiaChina(function (data) {
    ...
    MainView_bckup2022042001.prototype.ShareRHFDIAsiaPacific = function () {
        var container = document.getElementsByClassName("box-layout");
        container[0].remove();
        var category = new ResourceHumanDev();
        category.GetRHFDIIndiaChina(function (data) {
    ...
    //------------------------- Debt, inflation -----------------------------------
    MainView_bckup2022042001.prototype.Sharerhgggasiapacificdeveloping = function () {
        var container = document.getElementsByClassName("box-layout");
        container[0].remove();
        var category = new ResourceHumanDev();
        category.Getrhgggasiapacificdeveloping(function (data) {
    ...
    MainView_bckup2022042001.prototype.Sharerhirasiapacificdeveloping = function () {
        var container = document.getElementsByClassName("box-layout");
        container[0].remove();
        var category = new ResourceHumanDev();
        category.Getrhirasiapacificdeveloping(function (data) {
    ...
    //------------------------- Access to energy, water, sanitation -----------------------------------
    MainView_bckup2022042001.prototype.Sharerhaeasiapacific = function () {
        var container = document.getElementsByClassName("box-layout");
        container[0].remove();
        var category = new ResourceHumanDev();
        category.Getrhaeasiapacific(function (data) {
    ...
    MainView_bckup2022042001.prototype.Sharerhawater = function () {
        var container = document.getElementsByClassName("box-layout");
        container[0].remove();
        var category = new ResourceHumanDev();
        category.Getrhawater(function (data) {
    ...
    MainView_bckup2022042001.prototype.Sharerhasanitation = function () {
        var container = document.getElementsByClassName("box-layout");
        container[0].remove();
        var category = new ResourceHumanDev();
        category.Getrhasanitation(function (data) {
    ...
    return MainView_bckup2022042001;
}());
//# sourceMappingURL=mainview_bckup2022042001.js.map