...
var ResourceUse = /** @class */ (function (_super) {
    __extends(ResourceUse, _super);
    ...
    ResourceUse.prototype.GetGHGEmissionEnergy = function (func) {
        var self = this;
        this.Get("resourceuse/GetGHGEmissionEnergy", function (data) {
            var alldata = [];
...
//# sourceMappingURL=resourceuse.js.map