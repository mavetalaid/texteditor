...
var countryselected;
var indexCategory = 1;
var MainView_ = /** @class */ (function () {
    function MainView_() {
    }
    MainView_.prototype.Show = function () {
        this.ShowCategory();
        this.ShowCategory1();
        this.ShowCategory2();
        // this.ShowCategory3();
    ...
    MainView_.prototype.Showheader = function () {
    ...
    MainView_.prototype.ShowBanner = function () {
    ...
    MainView_.prototype.ShowCategory = function () {
    ...
    MainView_.prototype.ShowCategory1 = function () {
    ...
    MainView_.prototype.ShowCategory2 = function () {
    ...
    MainView_.prototype.ShowCategory3 = function () {
    ...
    MainView_.prototype.ShowCategory4 = function () {
    ...
    MainView_.prototype.ShowCategory5 = function () {
    ...
    MainView_.prototype.ShowCategory6 = function () {
    ...
    MainView_.prototype.ShowCategory7 = function () {
    ...
    MainView_.prototype.ShowIndicators = function (indicator, description, texts) {
        var self = this;
    ...
    MainView_.prototype.ShowIndicators2 = function (container, texts, availabledata) {
        var self = this;
    ...
    MainView_.prototype.ShowIndicators3 = function (container, texts, availabledata) {
        var self = this;
        var grid = new Xplore.Grid({ classes: ["grid-indicator"] });
        grid.rows = 2;
        grid.columns = 1;
    ...
    MainView_.prototype.ShowIndicators4 = function (container, texts, availabledata) {
        var self = this;
        var grid = new Xplore.Grid({ classes: ["grid-indicator"] });
        grid.rows = 2;
        grid.columns = 2;
    ...
    MainView_.prototype.ShowIndicators5 = function (container, texts, availabledata) {
        var self = this;
        var grid = new Xplore.Grid({ classes: ["grid-indicator"] });
        grid.rows = 3;
        grid.columns = 1;
    ...
    MainView_.prototype.ShowIndicators6 = function (container, texts, availabledata) {
        var self = this;
        var grid = new Xplore.Grid({ classes: ["grid-indicator"] });
        grid.rows = 3;
        grid.columns = 1;
    ...
    MainView_.prototype.ShowIndicators7 = function (container, texts, availabledata) {
        var self = this;
        var grid = new Xplore.Grid({ classes: ["grid-indicator"] });
        grid.rows = 3;
        grid.columns = 1;
    ...
    MainView_.prototype.ShowVisualization = function (type) {
        var self = this;
        var container = document.getElementById("visualization");
        container.innerHTML = "";
        var type_;
        var header = new Xplore.Container({ text: "VISUALIZATION", classes: ["catheader"] });
        header.Show(container);
        if (countryselected !== "All") {
    ...
    MainView_.prototype.ShowMaterialUse = function (container) {
    ...
    MainView_.prototype.ShowEnergyUse = function (container) {
    ...
    MainView_.prototype.ShowWaterUse = function (container) {
        // let todo = new Xplore.Text({ text: "Under Development", classes: ["under_dev"] })
        // todo.Show(container);
        var category = new NaturalResources();
    ...
    MainView_.prototype.ShowLandUse = function (container) {
        // let todo = new Xplore.Text({ text: "Under Development", classes: ["under_dev"] })
        // todo.Show(container);
        var category = new NaturalResources();
    ...
    MainView_.prototype.ShowAgriProd = function (container) {
        // let todo = new Xplore.Text({ text: "Under Development", classes: ["under_dev"] })
        // todo.Show(container);
        var category = new NaturalResources();
    ...
    MainView_.prototype.ShowWasteManage = function (container) {
        // let todo = new Xplore.Text({ text: "Under Development", classes: ["under_dev"] })
        // todo.Show(container);
        var category = new NaturalResources();
    ...
    MainView_.prototype.ShowGreenhouseGas = function (container) {
        var todo = new Xplore.Text({ text: "Under Development", classes: ["under_dev"] });
        todo.Show(container);
    };
    MainView_.prototype.ShowMaterialIntensity = function (container) {
    ...
    MainView_.prototype.ShowEnergyIntensity = function (container) {
        // let todo = new Xplore.Text({ text: "Under Development", classes: ["under_dev"] })
        // todo.Show(container);
        var category = new ResourceEfficiency();
    ...
    MainView_.prototype.ShowWaterIntensity = function (container) {
        var todo = new Xplore.Text({ text: "Under Development", classes: ["under_dev"] });
        todo.Show(container);
    };
    MainView_.prototype.ShowGHGIntensity = function (container) {
        var todo = new Xplore.Text({ text: "Under Development", classes: ["under_dev"] });
        todo.Show(container);
    };
    MainView_.prototype.ShowMaterialFootprint = function (container) {
    ...
    MainView_.prototype.ShowWaterFootprint = function (container) {
        var todo = new Xplore.Text({ text: "Under Development", classes: ["under_dev"] });
        todo.Show(container);
    };
    MainView_.prototype.ShowPTB = function (container) {
        // let todo = new Xplore.Text({ text: "Under Development", classes: ["under_dev"] })
        // todo.Show(container);
    ...
    MainView_.prototype.ShowUnitPriceTrade = function (container) {
        var todo = new Xplore.Text({ text: "Under Development", classes: ["under_dev"] });
        todo.Show(container);
    };
    MainView_.prototype.ShowHDI = function (container) {
        var todo = new Xplore.Text({ text: "Under Development", classes: ["under_dev"] });
        todo.Show(container);
    };
    MainView_.prototype.ShowEconGrowth = function (container) {
        var todo = new Xplore.Text({ text: "Under Development", classes: ["under_dev"] });
        todo.Show(container);
    };
    MainView_.prototype.ShowInvestmentCons = function (container) {
        // let todo = new Xplore.Text({ text: "Under Development", classes: ["under_dev"] })
        // todo.Show(container);
    ...
    MainView_.prototype.ShowDebtInflation = function (container) {
        var todo = new Xplore.Text({ text: "Under Development", classes: ["under_dev"] });
        todo.Show(container);
    };
    MainView_.prototype.ShowAccessEWS = function (container) {
        var todo = new Xplore.Text({ text: "Under Development", classes: ["under_dev"] });
        todo.Show(container);
    };
    MainView_.prototype.ShowCOVIDSpend = function (container) {
        var todo = new Xplore.Text({ text: "Under Development", classes: ["under_dev"] });
        todo.Show(container);
    };
    MainView_.prototype.ShowNaturalCapital = function (container) {
        var todo = new Xplore.Text({ text: "Under Development", classes: ["under_dev"] });
        todo.Show(container);
    };
    MainView_.prototype.ShowGreenSpend = function (container) {
        var todo = new Xplore.Text({ text: "Under Development", classes: ["under_dev"] });
        todo.Show(container);
    };
    MainView_.prototype.ShowGreenEnergy = function (container) {
        var todo = new Xplore.Text({ text: "Under Development", classes: ["under_dev"] });
        todo.Show(container);
    };
    MainView_.prototype.ShowGreenTransport = function (container) {
        var todo = new Xplore.Text({ text: "Under Development", classes: ["under_dev"] });
        todo.Show(container);
    };
    MainView_.prototype.ShowGreenResDev = function (container) {
        var todo = new Xplore.Text({ text: "Under Development", classes: ["under_dev"] });
        todo.Show(container);
    };
    MainView_.prototype.ShowBiofuelProd = function (container) {
        // let todo = new Xplore.Text({ text: "Under Development", classes: ["under_dev"] })
        // todo.Show(container);
    ...
    MainView_.prototype.ShowFooter = function () {
    ...
    MainView_.prototype.DataSet = function () {
    ...
    MainView_.prototype.Share = function (id) {
        switch (id) {
            case "NRAsiaPacific":
    ...
    //     });
    // }
    MainView_.prototype.ShareNRAsiaPacific = function (container) {
        var category = new NaturalResources();
        category.GetNRAsiaPacific(function (data) {
            var barchart = new XChart.StackedColumnChart(data);
            barchart.classes.push("chart-top-header");
    ...
    MainView_.prototype.ShareNRAsiaPacificMaterial = function (container) {
        var category = new NaturalResources();
        category.GetNRAsiaPacificMaterial(function (data) {
            var barchart = new XChart.StackedColumnChart(data);
            barchart.showtooltip = true;
...
//# sourceMappingURL=mainview_bckup%2014032022.js.map