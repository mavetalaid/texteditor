...
var MainView = /** @class */ (function () {
    ...
    MainView.prototype.ShowCategory = function () {
    ...
    MainView.prototype.ShowCategory1 = function () {
    ...
    MainView.prototype.ShowCategory2 = function () {
    ...
    MainView.prototype.ShowCategory3 = function () {
    ...
    MainView.prototype.ShowCategory4 = function () {
    ...
    MainView.prototype.ShowCategory5 = function () {
    ...
    MainView.prototype.ShowCategory6 = function () {
    ...
    MainView.prototype.ShowCategory7 = function () {
    ...
    MainView.prototype.ShowIndicators = function (indicator, description, texts) {
        var self = this;
    ...
    MainView.prototype.ShowIndicators2 = function (container, texts, availabledata) {
        var self = this;
    ...
    MainView.prototype.ShowIndicators3 = function (container, texts, availabledata) {
        var self = this;
        var grid = new Xplore.Grid({ classes: ["grid-indicator"] });
        grid.rows = 2;
        grid.columns = 1;
    ...
    MainView.prototype.ShowIndicators4 = function (container, texts, availabledata) {
        var self = this;
        var grid = new Xplore.Grid({ classes: ["grid-indicator"] });
        grid.rows = 2;
        grid.columns = 2;
    ...
    MainView.prototype.ShowIndicators5 = function (container, texts, availabledata) {
        var self = this;
        var grid = new Xplore.Grid({ classes: ["grid-indicator"] });
        grid.rows = 3;
        grid.columns = 1;
    ...
    MainView.prototype.ShowIndicators6 = function (container, texts, availabledata) {
        var self = this;
        var grid = new Xplore.Grid({ classes: ["grid-indicator"] });
        grid.rows = 3;
        grid.columns = 1;
    ...
    MainView.prototype.ShowIndicators7 = function (container, texts, availabledata) {
        var self = this;
        var grid = new Xplore.Grid({ classes: ["grid-indicator"] });
        grid.rows = 3;
        grid.columns = 1;
    ...
    MainView.prototype.ShowVisualization = function (type) {
        var self = this;
        var container = document.getElementById("visualization");
        container.innerHTML = "";
        var type_;
        var expander = new Xplore.Expander({ text: "Visualization" });
        var header = expander.Add(new Xplore.Container({ text: "VISUALIZATION", classes: ["catheader"] }));
        expander.Show(container);
        if (countryselected !== "All") {
    ...
    MainView.prototype.ShowMaterialUse = function (container) {
    ...
    MainView.prototype.ShowEnergyUse = function (container) {
    ...
    MainView.prototype.ShowWaterUse = function (container) {
        // let todo = new Xplore.Text({ text: "Under Development", classes: ["under_dev"] })
        // todo.Show(container);
        var category = new NaturalResources();
    ...
    MainView.prototype.ShowLandUse = function (container) {
        // let todo = new Xplore.Text({ text: "Under Development", classes: ["under_dev"] })
        // todo.Show(container);
        var category = new NaturalResources();
    ...
    MainView.prototype.ShowAgriProd = function (container) {
        // let todo = new Xplore.Text({ text: "Under Development", classes: ["under_dev"] })
        // todo.Show(container);
        var category = new NaturalResources();
    ...
    MainView.prototype.ShowWasteManage = function (container) {
        // let todo = new Xplore.Text({ text: "Under Development", classes: ["under_dev"] })
        // todo.Show(container);
        var category = new NaturalResources();
    ...
    MainView.prototype.ShowGreenhouseGas = function (container) {
        var todo = new Xplore.Text({ text: "Under Development", classes: ["under_dev"] });
        todo.Show(container);
    };
    MainView.prototype.ShowMaterialIntensity = function (container) {
    ...
    MainView.prototype.ShowEnergyIntensity = function (container) {
        // let todo = new Xplore.Text({ text: "Under Development", classes: ["under_dev"] })
        // todo.Show(container);
        var category = new ResourceEfficiency();
    ...
    MainView.prototype.ShowWaterIntensity = function (container) {
        var todo = new Xplore.Text({ text: "Under Development", classes: ["under_dev"] });
        todo.Show(container);
    };
    MainView.prototype.ShowGHGIntensity = function (container) {
        var todo = new Xplore.Text({ text: "Under Development", classes: ["under_dev"] });
        todo.Show(container);
    };
    MainView.prototype.ShowMaterialFootprint = function (container) {
    ...
    MainView.prototype.ShowWaterFootprint = function (container) {
        var todo = new Xplore.Text({ text: "Under Development", classes: ["under_dev"] });
        todo.Show(container);
    };
    MainView.prototype.ShowPTB = function (container) {
        // let todo = new Xplore.Text({ text: "Under Development", classes: ["under_dev"] })
        // todo.Show(container);
    ...
    MainView.prototype.ShowUnitPriceTrade = function (container) {
        var todo = new Xplore.Text({ text: "Under Development", classes: ["under_dev"] });
        todo.Show(container);
    };
    MainView.prototype.ShowHDI = function (container) {
        var todo = new Xplore.Text({ text: "Under Development", classes: ["under_dev"] });
        todo.Show(container);
    };
    MainView.prototype.ShowEconGrowth = function (container) {
        var todo = new Xplore.Text({ text: "Under Development", classes: ["under_dev"] });
        todo.Show(container);
    };
    MainView.prototype.ShowInvestmentCons = function (container) {
        // let todo = new Xplore.Text({ text: "Under Development", classes: ["under_dev"] })
        // todo.Show(container);
    ...
    MainView.prototype.ShowDebtInflation = function (container) {
        var todo = new Xplore.Text({ text: "Under Development", classes: ["under_dev"] });
        todo.Show(container);
    };
    MainView.prototype.ShowAccessEWS = function (container) {
        var todo = new Xplore.Text({ text: "Under Development", classes: ["under_dev"] });
        todo.Show(container);
    };
    MainView.prototype.ShowCOVIDSpend = function (container) {
        var todo = new Xplore.Text({ text: "Under Development", classes: ["under_dev"] });
        todo.Show(container);
    };
    MainView.prototype.ShowNaturalCapital = function (container) {
        var todo = new Xplore.Text({ text: "Under Development", classes: ["under_dev"] });
        todo.Show(container);
    };
    MainView.prototype.ShowGreenSpend = function (container) {
        var todo = new Xplore.Text({ text: "Under Development", classes: ["under_dev"] });
        todo.Show(container);
    };
    MainView.prototype.ShowGreenEnergy = function (container) {
        var todo = new Xplore.Text({ text: "Under Development", classes: ["under_dev"] });
        todo.Show(container);
    };
    MainView.prototype.ShowGreenTransport = function (container) {
        var todo = new Xplore.Text({ text: "Under Development", classes: ["under_dev"] });
        todo.Show(container);
    };
    MainView.prototype.ShowGreenResDev = function (container) {
        var todo = new Xplore.Text({ text: "Under Development", classes: ["under_dev"] });
        todo.Show(container);
    };
    MainView.prototype.ShowBiofuelProd = function (container) {
        // let todo = new Xplore.Text({ text: "Under Development", classes: ["under_dev"] })
        // todo.Show(container);
    ...
    MainView.prototype.ShowFooter = function () {
    ...
    MainView.prototype.DataSet = function () {
    ...
    MainView.prototype.Share = function (id) {
        switch (id) {
            case "NRAsiaPacific":
    ...
    //     });
    // }
    MainView.prototype.ShareNRAsiaPacific = function (container) {
        var category = new NaturalResources();
        category.GetNRAsiaPacific(function (data) {
            var barchart = new XChart.StackedColumnChart(data);
            barchart.classes.push("chart-top-header");
    ...
    MainView.prototype.ShareNRAsiaPacificMaterial = function (container) {
        var category = new NaturalResources();
        category.GetNRAsiaPacificMaterial(function (data) {
            var barchart = new XChart.StackedColumnChart(data);
            barchart.showtooltip = true;
...
//# sourceMappingURL=mainview%20copy.js.map