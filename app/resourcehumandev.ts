class ResourceHumanDev extends CategoryBase {

    //------------------------- Human Development Index (HDI) -----------------------------------

    GetrhHDIdmc2010(func: Function) {
        let self = this;

        this.Get("resourceshuman/GetrhHDIdmc2010", function (data: UNEPTableRow[]) {
            let alldata = [];
    ...
    GetrhHDIdmc2017(func: Function) {
        let self = this;

        this.Get("resourceshuman/GetrhHDIdmc2017", function (data: UNEPTableRow[]) {
            let alldata = [];
    ...
    GetrhHDImf2010(func: Function) {
        let self = this;

        this.Get("resourceshuman/GetrhHDImf2010", function (data: UNEPTableRow[]) {
            let alldata = [];
    ...
    GetrhHDImf2017(func: Function) {
        let self = this;

        this.Get("resourceshuman/GetrhHDImf2017", function (data: UNEPTableRow[]) {
            let alldata = [];
    ...
    GetrhGDPdmc2010(func: Function) {
        let self = this;

        this.Get("resourceshuman/GetrhGDPdmc2010", function (data: UNEPTableRow[]) {
            let alldata = [];
    ...
    GetrhGDPdmc2017(func: Function) {
        let self = this;

        this.Get("resourceshuman/GetrhGDPdmc2017", function (data: UNEPTableRow[]) {
            let alldata = [];
    ...
    GetrhGDPmf2010(func: Function) {
        let self = this;

        this.Get("resourceshuman/GetrhGDPmf2010", function (data: UNEPTableRow[]) {
            let alldata = [];
    ...
    GetrhGDPmf2017(func: Function) {
        let self = this;

        this.Get("resourceshuman/GetrhGDPmf2017", function (data: UNEPTableRow[]) {
            let alldata = [];
    ...
    GetrhEGDPdmc2010(func: Function) {
        let self = this;

        this.Get("resourceshuman/GetrhEGDPdmc2010", function (data: UNEPTableRow[]) {
            let alldata = [];
    ...
    GetrhEGDPdmc2017(func: Function) {
        let self = this;

        this.Get("resourceshuman/GetrhEGDPdmc2017", function (data: UNEPTableRow[]) {
            let alldata = [];
    ...
    GetrhEGDPmf2010(func: Function) {
        let self = this;

        this.Get("resourceshuman/GetrhEGDPmf2010", function (data: UNEPTableRow[]) {
            let alldata = [];
    ...
    GetrhEGDPmf2017(func: Function) {
        let self = this;

        this.Get("resourceshuman/GetrhEGDPmf2017", function (data: UNEPTableRow[]) {
            let alldata = [];
    ...
    GetRHFDIIndiaChina(func: Function) {
        let self = this;

        this.Get("resourceshuman/GetRHFDIIndiaChina", function (data: UNEPTableRow[]) {
            let alldata = [];
    ...
    GetRHFDIAsiaPacific(func: Function) {
        let self = this;

        this.Get("resourceshuman/GetRHFDIAsiaPacific", function (data: UNEPTableRow[]) {
            let alldata = [];
    ...
    Getrhgggasiapacificdeveloping(func: Function) {
        let self = this;

        this.Get("resourceshuman/Getrhgggasiapacificdeveloping", function (data: UNEPTableRow[]) {
            let alldata = [];
    ...
    Getrhirasiapacificdeveloping(func: Function) {
        let self = this;

        this.Get("resourceshuman/Getrhirasiapacificdeveloping", function (data: UNEPTableRow[]) {
            let alldata = [];
    ...
    Getrhaeasiapacific(func: Function) {
        let self = this;

        this.Get("resourceshuman/Getrhaeasiapacific", function (data: UNEPTableRow[]) {
            let alldata = [];
    ...
    Getrhawater(func: Function) {
        let self = this;

        this.Get("resourceshuman/Getrhawater", function (data: UNEPTableRow[]) {
            let alldata = [];
    ...
    Getrhasanitation(func: Function) {
        let self = this;

        this.Get("resourceshuman/Getrhasanitation", function (data: UNEPTableRow[]) {
            let alldata = [];
