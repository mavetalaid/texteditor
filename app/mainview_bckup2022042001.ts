...
class MainView_bckup2022042001 {
    ...
    ShowIndicators(indicator: string, description: string, texts: string[]): void {
        ...
        let catdes = new Xplore.Container({ classes: ["category-desc"] }); // category
        let titlecategory = catdes.Add(new Xplore.Text({ text: indicator }));
        let desccategory = catdes.Add(new Xplore.Text({ text: description }));

        catdes.Show(container);

        let catcontainer = new Xplore.Container({ classes: ["catcontainer"] }); // indicator

        let titleindi = catcontainer.Add(new Xplore.Text({ text: indicator, classes: ["catheader"] }));
        let descindi = catcontainer.Add(new Xplore.TextBlock({ text: description, classes: ["indicator-desc"] }));
