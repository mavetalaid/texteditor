...
class MainView_1 {
    ...
    ShowVisualization(type: string): void {
        ...
        let expander = new Xplore.Expander({ text: " " });

        let header = expander.Add(new Xplore.Container({ text: " ", classes: ["catheader"] }));
        expander.Show(container);
    ...
    ShowMaterialUse(container: Xplore): void {
    ...
    ShowEnergyUse(container: Xplore): void {
    ...
    ShowWaterUse(container: Xplore): void {
        // let todo = new Xplore.Text({ text: "Under Development", classes: ["under_dev"] })
        // todo.Show(container);
    ...
    ShowLandUse(container: Xplore): void {
        // let todo = new Xplore.Text({ text: "Under Development", classes: ["under_dev"] })
        // todo.Show(container);
    ...
    ShowAgriProd(container: Xplore): void {
        // let todo = new Xplore.Text({ text: "Under Development", classes: ["under_dev"] })
        // todo.Show(container);
    ...
    ShowWasteManage(container: Xplore): void {
        // let todo = new Xplore.Text({ text: "Under Development", classes: ["under_dev"] })
        // todo.Show(container);
    ...
    ShowMaterialIntensity(container: Xplore): void {
    ...
    ShowMaterialFootprint(container: Xplore): void {
    ...
    ShowInvestmentCons(container: Xplore): void {
        // let todo = new Xplore.Text({ text: "Under Development", classes: ["under_dev"] })
        // todo.Show(container);
    ...
    ShowBiofuelProd(container: Xplore): void {
        // let todo = new Xplore.Text({ text: "Under Development", classes: ["under_dev"] })
        // todo.Show(container);
    ...
    ShareREAsiaPacificWorld(container?: HTMLElement): void {
        let category = new ResourceEfficiency();
        category.GetREAsiaPacificWorld(function (data: XChartDataSet) {
            let barchart = new XChart.StackedColumnChart(data);
            barchart.classes.push("chart-top-header");
    ...
    ShareREAsiaPacificDeveloping(container?: HTMLElement): void {
        let category = new ResourceEfficiency();
        category.GetREAsiaPacificDeveloping(function (data: XChartDataSet) {
            let barchart = new XChart.StackedColumnChart(data);
            barchart.classes.push("chart-top-header");
